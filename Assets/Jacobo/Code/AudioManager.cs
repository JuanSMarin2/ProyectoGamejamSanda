...
public class AudioManager : MonoBehaviour
{
    ...
    private void Start()
    {
        // Try to find AudioConfig in the scene
        AudioConfig audioConfig = FindFirstObjectByType<AudioConfig>();
        
        if (audioConfig != null)
        {
            InitializeAmbience(audioConfig.sceneAmbience);
            InitializeMusic(audioConfig.sceneMusic);
        }
        else
        {
            Debug.LogWarning("No AudioConfig found in the scene. Audio configuration not initialized.");
        }
    }
